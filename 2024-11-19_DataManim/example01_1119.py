...
# res = df.groupby(['neighbourhood_group', 'neighbourhood'],
#                  as_index=False).size()
# res = res.groupby("neighbourhood_group").max()
# print(res)

# # 48 groupby neighbourhood_group and price avg,deviation,max,min
# res = df[['neighbourhood_group', 'price']].groupby(
#     'neighbourhood_group').agg(["mean", "var", "min", "max"])
# print(res)
...
# res = df[["neighbourhood_group", "neighbourhood", "price"]].groupby(
#     ["neighbourhood_group", "neighbourhood"]
# ).mean().unstack()
# print(res)

# # 52 groupby neighbourhood, neibourhood_group and price_mean without hierarchical indexing and fill na -999
# res = df[["neighbourhood_group", "neighbourhood", "price"]
#          ].groupby(["neighbourhood_group", "neighbourhood"]).mean().unstack().fillna(-999)
# print(res)
...
# print(res)
# res = df.groupby(["Year", "Medal"]).size().unstack()
# print(res)
